...
<nav class="w3-sidebar w3-black w3-animate-top w3-xxlarge" style="display:none;padding-top:150px" id="mySidebar">
    ...
    <div class="w3-bar-block w3-center">@if (Route::has('login'))
            <div class="top-right links">
                @auth
                    <a href="{{ url('/home') }}" class="w3-bar-item w3-button w3-text-grey w3-hover-black">Home</a>
                @else
                    <a href="{{ route('login') }}" class="w3-bar-item w3-button w3-text-grey w3-hover-black">Login</a>

                    @if (Route::has('register'))
                        <a href="{{ route('register') }}" class="w3-bar-item w3-button w3-text-grey w3-hover-black">Register</a>
                    @endif
                @endauth
            </div>
        @endif
